/* g++ final_7.cpp -o final_7 -lwiringPi $(pkg-config --libs --cflags opencv) */
...
int main()
{
	...
	while(true)	{
		...
		/* 노란색 검출 */
		detectHScolor(Video, 20, 50, 30, 255, mask);	// Hue range (20~70), Saturation (15, 230)
		...
		buffer = (6 / 35) * vector_real - (2760 / 7);
