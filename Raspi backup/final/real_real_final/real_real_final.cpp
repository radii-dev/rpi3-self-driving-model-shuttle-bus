/* g++ -Wall -w -o2 real_real_final.cpp cv.cpp system_management.cpp image_processing.cpp car_control.cpp car_lib.c -o real_real_final `pkg-config --libs opencv` -lwiringPi */
/*
...
g++ -c car_control.cpp
g++ -c car_lib.c
g++ -Wall -w -o2 -o real_real_final real_real_final.cpp system_management.o cv.o image_processing.o car_control.o car_lib.o 'pkg-config --libs opencv' -lwiringPi
...
int main()
{
    ...
    while(cap.isOpened()) { // check if camera/ video stream is available
        ...
        //buffer += 0b10000000;
        //buffer += (cvResult.direction / 20)-75;
        //buffer = 75;
